...
squared_nums = [x**2 for x in range(0,9)]
#print(squared_nums)
...
nums_list = ["big" if x > 5 else "small" for x in range(0,9)]
#print(nums_list)
...
sum_of_combinations = [x+y for x in range(0,2) for y in range(0,3)]
...
list_matches = [(x,y) if x!=y else ("match", y) for x in range(0,2) for y in range(0,2)]
#print(list_matches)
...
days = ["Mon", "Tue"]
temps = [20,35]
list_days_temps = [(day, "hot") if temp > 30 else (day, "cool") for day in days for temp in temps] 
